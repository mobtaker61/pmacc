...
return [
    ...
    //
    // If false, system will take app.php locale attribute or session/cookie value
    'useAcceptLanguageHeader' => false, // Set to false to rely on session/controller logic

    // If `hideDefaultLocaleInURL` is true, then a url without locale
    // is identical with the same url with default locale.
    // For example, if `fa` is default locale, then `/fa/dashboard` and `/dashboard`
    // would be identical.
    //
    ...
    // For example, `/fa/dashboard` would be redirected to `/dashboard`.
    ...
    'hideDefaultLocaleInURL' => true, // Set to true to hide the default locale (fa) from URL
